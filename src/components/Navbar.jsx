    ...
    <div className="relative bg-[#3DBEFF] p-5 flex justify-between items-center">
      ...
      {isMenuOpen && (
        <div className="flex flex-col items-center justify-center text-center fixed top-0 right-0 h-1/2 w- md:w-1/2 p-10 bg-white z-50 ">
          <Link to="/about" className="font-barlow font-600 text-md text-grayishblue mb-5">About</Link>
          <Link to="/services" className="font-barlow font-600 text-md text-grayishblue mb-5">Services</Link>
          <Link to="/projects" className="font-barlow font-600 text-md text-grayishblue mb-5">Projects</Link>
