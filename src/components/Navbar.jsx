...
const Navbar = () => {
  ...
  return (
    <div className="relative bg-[#3DBEFF] p-5 flex justify-between items-center">
      ...
      {isMenuOpen && (
        <div className="flex flex-col items-center justify-center bg-white text-center fixed top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-1/3 w-1/2 z-50">
          <Link
            to="/about"
