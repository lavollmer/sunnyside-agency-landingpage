...
const Brand = () => {
  return (
    <div className="bg-[#FFFBF8] p-10 md:p-40 flex flex-col space-y-16">
      <h1 className="flex flex-row items-center font-fraunces font-700 md:text-md text-center md:text-left text-[#202C35]">
        Transform your brand
      </h1>
      <p className="text-sm md:text-md front-barlow font-bold font-800 items-center text-center md:text-left text-[#B0AFB4]">
